...
class MemoryOverlay {
  ...
  async peekLastTreeNode () {
    const mem = this.treeNodes !== null ? this.treeNodes.get(this.treeNodes.length() - 1) : null
  ...
  async peekLastBitfieldPage () {
    const page = this.bitfields !== null ? this.bitfields.get(this.bitfields.length() - 1) : null
