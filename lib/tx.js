...
class CoreTX {
  ...
  setBatches (batches) {
    this.changes.push([core.batches(this.core.corePointer), encode(CORE_BATCHES, batches), null])
  }
  ...
  setDependencies (deps) {
    this.changes.push([core.dependencies(this.core.dataPointer), encode(CORE_DEPENDENCIES, deps), null])
  }

  setHints (hints) {
    this.changes.push([core.dependencies(this.core.dataPointer), encode(CORE_HINTS, hints), null])
  }
...
class CoreRX {
  ...
  async getBatches () {
    return await decode(CORE_BATCHES, await this.view.get(this.read, core.batches(this.core.corePointer)))
  }
  ...
  async getDependencies () {
    return await decode(CORE_DEPENDENCIES, await this.view.get(this.read, core.dependencies(this.core.dataPointer)))
  }
