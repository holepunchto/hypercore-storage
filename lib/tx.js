...
class CoreTX {
  ...
  putGroupUpdate(groupID, timestamp, key) {
    this.changes.push([group.entry(groupID, timestamp, this.core.corePointer), key, null])
  }

  deleteGroupUpdate(groupID, timestamp) {
    this.changes.push([group.entry(groupID, timestamp, this.core.corePointer), null, null])
  }
...
class CorestoreTX {
  ...
  putGroup(topic, groupID) {
    this.changes.push([group.topic(topic), encode(CORESTORE_GROUP, groupID), null])
  }
